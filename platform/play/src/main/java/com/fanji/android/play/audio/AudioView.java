package com.fanji.android.play.audio;
...
public class AudioView extends View {
     ...
     * 频谱数量
     */
    private static int LUMP_COUNT = 128;
    ...
    private static int LUMP_MAX_HEIGHT = 200;//TODO: HEIGHT
    private static final int LUMP_SIZE = LUMP_WIDTH + LUMP_SPACE;
    private static int LUMP_COLOR = Color.parseColor("#6de8fd");
    ...
    private void drawLump(Canvas canvas, int i, boolean reversal) {
        ...
        if (waveData[i] < 0) {
            LogUtil.w("waveData[i] < 0 cacheData: %s", waveData[i]);
        }
