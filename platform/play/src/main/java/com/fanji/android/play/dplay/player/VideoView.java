package com.fanji.android.play.dplay.player;
...
import com.fanji.android.play.Play;
import com.fanji.android.play.R;
import com.fanji.android.play.dplay.controller.BaseVideoController;
import com.fanji.android.play.dplay.controller.MediaPlayerControl;
import com.fanji.android.play.dplay.render.IRenderView;
import com.fanji.android.play.dplay.render.RenderViewFactory;
import com.fanji.android.play.dplay.util.L;
...
//import com.android.player.dplay.render.IRenderView;
//import com.android.player.dplay.render.RenderViewFactory;
//import com.android.player.dplay.util.L;
...
public class VideoView<P extends AbstractPlayer> extends FrameLayout
    ...
    protected boolean mIsMute = true;//是否静音
     ...
     * 循环播放
     */
    protected boolean mIsLooping = true;
    ...
    public VideoView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        mPlayerBackgroundColor = a.getColor(R.styleable.VideoView_playerBackgroundColor, Color.alpha(0));
        a.recycle();
    ...
    public void setBg(Drawable drawable) {
        if (mPlayerContainer == null) return;
        mPlayerContainer.setBackground(drawable);
    }

    public void setCover(String url, int defaultImg) {
        if (mCover == null) return;
        FJImg.loadImage(url, mCover, defaultImg);
    }
     ...
     * 设置视频地址
     */
    public void setUrl(String url, boolean isCache) {
        if (isCache) {
            setUrl(Play.INSTANCE.getVideoUrl(url), null);
        } else {
            setUrl(url, null);
        }
    }
