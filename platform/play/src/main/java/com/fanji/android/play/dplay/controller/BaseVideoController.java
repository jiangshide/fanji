package com.fanji.android.play.dplay.controller;
...
import com.fanji.android.play.dplay.util.CutoutUtil;
...
public abstract class BaseVideoController extends FrameLayout
    ...
    protected void initView() {
        if (getLayoutId() != 0) {
            mControllerView = LayoutInflater.from(getContext()).inflate(getLayoutId(), this, true);
        }
