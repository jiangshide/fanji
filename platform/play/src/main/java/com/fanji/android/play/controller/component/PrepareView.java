...
public class PrepareView extends FrameLayout implements IControlComponent {
    ...
    public void setCover(String url,int resId){
        if(mThumb == null)return;
        FJImg.loadImage(url,mThumb,resId);
    }
    ...
    public void onPlayStateChanged(int playState) {
        switch (playState) {
            case VideoView.STATE_PREPARING:
                ...
                mNetWarning.setVisibility(GONE);
                mLoading.setVisibility(View.GONE);//隐藏进度加载
                break;
            ...
            case VideoView.STATE_IDLE:
                ...
                mNetWarning.setVisibility(GONE);
                mStartPlay.setVisibility(View.GONE);//自动播放时：隐藏播放按钮
