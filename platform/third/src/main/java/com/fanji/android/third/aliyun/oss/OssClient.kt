package com.fanji.android.third.aliyun.oss
...
//            }
   ...
   * @return
   */
  fun delete(bucketUrl: String?): Boolean {
    val deleteObjectRequest = DeleteObjectRequest("zd112",bucketUrl)
    getOss()?.asyncDeleteObject(deleteObjectRequest,object :OSSCompletedCallback<DeleteObjectRequest,DeleteObjectResult>{
