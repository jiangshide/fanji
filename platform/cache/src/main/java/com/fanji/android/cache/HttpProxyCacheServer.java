...
import com.fanji.android.cache.file.DiskUsage;
import com.fanji.android.cache.file.FileNameGenerator;
import com.fanji.android.cache.file.Md5FileNameGenerator;
import com.fanji.android.cache.file.TotalCountLruDiskUsage;
import com.fanji.android.cache.file.TotalSizeLruDiskUsage;
import com.fanji.android.cache.headers.EmptyHeadersInjector;
import com.fanji.android.cache.headers.HeaderInjector;
import com.fanji.android.cache.sourcestorage.SourceInfoStorage;
import com.fanji.android.cache.sourcestorage.SourceInfoStorageFactory;
...
import static com.fanji.android.cache.Preconditions.checkAllNotNull;
import static com.fanji.android.cache.Preconditions.checkNotNull;
...
public class HttpProxyCacheServer {
    ...
    public void registerCacheListener(CacheListener cacheListener, String url) {
        ...
        synchronized (clientsLock) {
            try {
                ...
                LogUtil.w("Error registering cache listener");
            }
        }
    }
    ...
    private void touchFileSafely(File cacheFile) {
        try {
            ...
            LogUtil.e("Error touching file " + cacheFile);
        }
    }
    ...
    private void closeSocketOutput(Socket socket) {
        try {
            ...
            LogUtil.w("Failed to close socket on proxy side: {}. It seems client have already closed connection.");
        }
    }
    ...
    private void onError(Throwable e) {
        LogUtil.e("HttpProxyCacheServer error");
    }
