...
import static com.fanji.android.cache.Preconditions.checkArgument;
...
class Pinger {
    ...
    boolean ping(int maxAttempts, int startTimeout) {
        ...
        while (attempts < maxAttempts) {
            try {
                ...
                LogUtil.e("Error pinging server due to unexpected error");
            }
            attempts++;
            timeout *= 2;
        }
    ...
    private boolean pingServer() throws ProxyCacheException {
        ...
        try {
            ...
            LogUtil.e("Error reading ping response");
            return false;
        } finally {
            source.close();
        }
