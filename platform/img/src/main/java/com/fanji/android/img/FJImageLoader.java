...
import com.fanji.android.img.progress.GlideApp;
import com.fanji.android.img.progress.GlideRequest;
import com.fanji.android.img.progress.ProgressManager;
...
public class FJImageLoader {
    ...
    public static FJImageLoader create(ImageView imageView) {
        return new FJImageLoader(imageView);
    }

    private FJImageLoader(ImageView imageView) {
    ...
    public FJImageLoader load(@DrawableRes int resId, @DrawableRes int placeholder, @NonNull Transformation<Bitmap> transformation) {
//        return loadImage(resId2Uri(resId), placeholder, transformation);
    ...
    public FJImageLoader loadImage(Object obj, @DrawableRes int placeholder, Transformation<Bitmap> transformation) {
    ...
    public FJImageLoader listener(Object obj, IProgressListener iProgressListener) {
        if (obj instanceof String) {
            url = (String) obj;
        }
