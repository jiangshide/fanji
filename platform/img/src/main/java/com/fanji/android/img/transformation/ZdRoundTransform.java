 ...
 */
public class ZdRoundTransform extends BitmapTransformation {

    private static final int VERSION = 1;
    private static final String ID = "com.ohdance.framework.image.ZdRoundTransform." + VERSION;
    ...
    public ZdRoundTransform(int radius) {
        this(radius, 0);
    }

    public ZdRoundTransform(int radius, int margin) {
        this(radius, margin, CornerType.ALL);
    }

    public ZdRoundTransform(int radius, CornerType cornerType) {
        this(radius, 0, cornerType);
    }

    public ZdRoundTransform(int radius, int margin, CornerType cornerType) {
        this.radius = radius;
    ...
    public String toString() {
        return "ZdRoundTransform(radius=" + radius + ", margin=" + margin + ", diameter="
                + diameter + ", cornerType=" + cornerType.name() + ")";
    }

    @Override
    public boolean equals(Object o) {
        return o instanceof ZdRoundTransform &&
                ((ZdRoundTransform) o).radius == radius &&
                ((ZdRoundTransform) o).diameter == diameter &&
                ((ZdRoundTransform) o).margin == margin &&
                ((ZdRoundTransform) o).cornerType == cornerType;
    }
