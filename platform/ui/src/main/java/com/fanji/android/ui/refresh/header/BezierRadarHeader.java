...
//    protected ValueAnimator mRadarAnimator;
    ...
    public BezierRadarHeader(Context context, AttributeSet attrs) {
        ...
        setAccentColor(ta.getColor(R.styleable.BezierRadarHeader_srlAccentColor, 0xFF1F1E23));
        setPrimaryColor(ta.getColor(R.styleable.BezierRadarHeader_srlPrimaryColor, 0xFF33353f));
