 ...
 */
public class FJCircleImg extends FJImageView {
  ...
  public FJCircleImg(Context context) {
    super(context);

    init();
  }

  public FJCircleImg(Context context, AttributeSet attrs) {
    this(context, attrs, 0);
  }

  public FJCircleImg(Context context, AttributeSet attrs, int defStyle) {
    super(context, attrs, defStyle);

    TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.FJCircleImageView, defStyle, 0);

    mBorderWidth =
        a.getDimensionPixelSize(R.styleable.FJCircleImageView_civ_border_width, DEFAULT_BORDER_WIDTH);
    mBorderColor = a.getColor(R.styleable.FJCircleImageView_civ_border_color, DEFAULT_BORDER_COLOR);
    mBorderOverlay =
        a.getBoolean(R.styleable.FJCircleImageView_civ_border_overlay, DEFAULT_BORDER_OVERLAY);
    mCircleBackgroundColor = a.getColor(R.styleable.FJCircleImageView_civ_circle_background_color,
