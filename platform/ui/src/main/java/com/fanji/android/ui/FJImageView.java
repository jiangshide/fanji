...
import com.fanji.android.img.FJImageLoader;
import com.fanji.android.img.listener.IProgressListener;
import com.fanji.android.img.transformation.CircleTransformation;
import com.fanji.android.img.transformation.RadiusTransformation;

/**
 * created by jiangshide on 2017-03-20.
 * email:18311271399@163.com
 */
public class FJImageView extends AppCompatImageView {
    ...
    private FJImageLoader imageLoader;
    ...
    public FJImageView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
        init(context, attrs);
    }

    public FJImageView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        leftTopRadius =
                array.getDimensionPixelOffset(R.styleable.Custom_Round_Image_View_left_top_radius,
                        defaultRadius);
        rightTopRadius =
                array.getDimensionPixelOffset(R.styleable.Custom_Round_Image_View_right_top_radius,
                        defaultRadius);
        rightBottomRadius =
                array.getDimensionPixelOffset(R.styleable.Custom_Round_Image_View_right_bottom_radius,
                        defaultRadius);
        leftBottomRadius =
                array.getDimensionPixelOffset(R.styleable.Custom_Round_Image_View_left_bottom_radius,
                        defaultRadius);
        ...
        array.recycle();
        imageLoader = FJImageLoader.create(this);
    }

    public FJImageLoader getImageLoader() {
        if (imageLoader == null) {
            imageLoader = FJImageLoader.create(this);
        }
        return imageLoader;
    ...
    public FJImageView apply(RequestOptions options) {
        getImageLoader().getGlideRequest().apply(options);
        return this;
    }

    public FJImageView centerCrop() {
        getImageLoader().getGlideRequest().centerCrop();
        return this;
    }

    public FJImageView fitCenter() {
        getImageLoader().getGlideRequest().fitCenter();
        return this;
    }

    public FJImageView diskCacheStrategy(@NonNull DiskCacheStrategy strategy) {
        getImageLoader().getGlideRequest().diskCacheStrategy(strategy);
        return this;
    }

    public FJImageView placeholder(@DrawableRes int resId) {
        getImageLoader().getGlideRequest().placeholder(resId);
        return this;
    }

    public FJImageView error(@DrawableRes int resId) {
        getImageLoader().getGlideRequest().error(resId);
        return this;
    }

    public FJImageView fallback(@DrawableRes int resId) {
        getImageLoader().getGlideRequest().fallback(resId);
        return this;
    }

    public FJImageView dontAnimate() {
        getImageLoader().getGlideRequest().dontTransform();
        return this;
    }

    public FJImageView dontTransform() {
        getImageLoader().getGlideRequest().dontTransform();
        return this;
    }
    ...
    public void loadCircle(String url, IProgressListener iProgressListener) {
        load(url, 0, new CircleTransformation(), iProgressListener);
    }
    ...
    public FJImageView enableState(boolean enableState) {
        this.enableState = enableState;
        return this;
    }

    public FJImageView pressedAlpha(float pressedAlpha) {
        this.pressedAlpha = pressedAlpha;
        return this;
    }

    public FJImageView unableAlpha(float unableAlpha) {
