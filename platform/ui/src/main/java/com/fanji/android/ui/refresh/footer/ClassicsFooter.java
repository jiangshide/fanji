package com.fanji.android.ui.refresh.footer;
...
import com.fanji.android.ui.refresh.internal.ArrowDrawable;
import com.fanji.android.ui.refresh.internal.InternalClassics;
import com.fanji.android.ui.refresh.internal.ProgressDrawable;
...
public class ClassicsFooter extends InternalClassics<ClassicsFooter> implements RefreshFooter {
    ...
    public ClassicsFooter(Context context, AttributeSet attrs) {
        ...
        lpProgress.rightMargin = ta.getDimensionPixelSize(R.styleable.ClassicsFooter_srlDrawableMarginRight, SmartUtil
                .dp2px(20));
        ...
        if (ta.hasValue(R.styleable.ClassicsFooter_srlTextSizeTitle)) {
            mTitleText.setTextSize(TypedValue.COMPLEX_UNIT_PX, ta.getDimensionPixelSize(R.styleable.ClassicsFooter_srlTextSizeTitle, SmartUtil
                    .dp2px(16)));
        }
