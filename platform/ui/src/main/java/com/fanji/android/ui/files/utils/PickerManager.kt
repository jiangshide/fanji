package com.fanji.android.ui.files.utils

import android.content.pm.ActivityInfo
import android.net.Uri
import com.fanji.android.ui.R
import com.fanji.android.ui.files.models.BaseFile
import com.fanji.android.ui.files.models.FileType
import com.fanji.android.ui.files.models.sort.SortingTypes
...
object PickerManager {
    ...
    var cameraDrawable = R.mipmap.ic_camera
...
//    var theme : Int = R.style.LibAppTheme
    ...
    fun addDocTypes() {
        ...
        fileTypes.add(FileType(FilePickerConst.PDF, pdfs, R.mipmap.icon_file_pdf))

        val docs = arrayOf("doc", "docx", "dot", "dotx")
        fileTypes.add(FileType(FilePickerConst.DOC, docs, R.mipmap.icon_file_doc))

        val ppts = arrayOf("ppt", "pptx")
        fileTypes.add(FileType(FilePickerConst.PPT, ppts, R.mipmap.icon_file_ppt))

        val xlss = arrayOf("xls", "xlsx")
        fileTypes.add(FileType(FilePickerConst.XLS, xlss, R.mipmap.icon_file_xls))
