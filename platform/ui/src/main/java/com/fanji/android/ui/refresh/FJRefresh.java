package com.fanji.android.ui.refresh;
...
import static com.fanji.android.ui.refresh.util.SmartUtil.dp2px;
import static com.fanji.android.ui.refresh.util.SmartUtil.fling;
import static com.fanji.android.ui.refresh.util.SmartUtil.isContentView;
...
import com.fanji.android.ui.refresh.api.DefaultRefreshFooterCreator;
import com.fanji.android.ui.refresh.api.DefaultRefreshHeaderCreator;
import com.fanji.android.ui.refresh.api.DefaultRefreshInitializer;
import com.fanji.android.ui.refresh.api.RefreshContent;
...
import com.fanji.android.ui.refresh.api.ScrollBoundaryDecider;
import com.fanji.android.ui.refresh.constant.DimensionStatus;
import com.fanji.android.ui.refresh.constant.RefreshState;
import com.fanji.android.ui.refresh.constant.SpinnerStyle;
import com.fanji.android.ui.refresh.footer.BallPulseFooter;
import com.fanji.android.ui.refresh.header.BezierRadarHeader;
import com.fanji.android.ui.refresh.impl.RefreshContentWrapper;
...
import com.fanji.android.ui.refresh.listener.OnMultiPurposeListener;
import com.fanji.android.ui.refresh.listener.OnRefreshListener;
import com.fanji.android.ui.refresh.listener.OnRefreshLoadMoreListener;
...
public class FJRefresh extends ViewGroup implements RefreshLayout, NestedScrollingParent {
    ...
    public FJRefresh(Context context) {
        this(context, null);
    }

    public FJRefresh(Context context, AttributeSet attrs) {
        super(context, attrs);
        ...
        mHeaderHeightStatus = ta.hasValue(
                R.styleable.SmartRefreshLayout_srlHeaderHeight) ? DimensionStatus.XmlLayoutUnNotify : mHeaderHeightStatus;
        mFooterHeightStatus = ta.hasValue(
                R.styleable.SmartRefreshLayout_srlFooterHeight) ? DimensionStatus.XmlLayoutUnNotify : mFooterHeightStatus;
        ...
        AnimatorListenerAdapter listener = new AnimatorListenerAdapter() {
            ...
            public void onAnimationEnd(Animator animation) {
                ...
                if (mRefreshListener != null) {
                    if (notify) {
                        mRefreshListener.onRefresh(FJRefresh.this);
                    }
                } else if (mOnMultiPurposeListener == null) {
                    finishRefresh(3000);
                }
                if (mRefreshHeader != null) {
                    mRefreshHeader.onStartAnimator(
                            FJRefresh.this, mHeaderHeight, (int) (mHeaderMaxDragRate * mHeaderHeight));
                }
                if (mOnMultiPurposeListener != null && mRefreshHeader instanceof RefreshHeader) {
                    if (notify) {
                        mOnMultiPurposeListener.onRefresh(FJRefresh.this);
                    }
    ...
    protected void moveSpinnerInfinitely(float spinner) {
        ...
        if (mEnableAutoLoadMore && !mFooterNoMoreData && isEnableRefreshOrLoadMore(mEnableLoadMore) && spinner < 0
            ...
            mHandler.postDelayed(new Runnable() {
                ...
                public void run() {
                    if (mLoadMoreListener != null) {
                        mLoadMoreListener.onLoadMore(FJRefresh.this);
                    } else if (mOnMultiPurposeListener == null) {
                        finishLoadMore(2000);//如果没有任何加载监听器，两秒之后自动关闭
                    }
                    final OnLoadMoreListener listener = mOnMultiPurposeListener;
                    if (listener != null) {
                        listener.onLoadMore(FJRefresh.this);
                    }
                }
            }, mReboundDuration);
        }
     ...
     * Recommended {@link com.fanji.android.refresh.listener.SimpleMultiPurposeListener}
     * 设置多功能监听器
     * 建议使用 {@link com.fanji.android.refresh.listener.SimpleMultiPurposeListener}
     *
     ...
     * Recommended {@link com.fanji.android.refresh.impl.ScrollBoundaryDeciderAdapter}
     * 设置滚动边界判断器
     * 建议使用 {@link com.fanji.android.refresh.impl.ScrollBoundaryDeciderAdapter}
     *
        ...
        Runnable runnable = new Runnable() {
            ...
            public void run() {
                if (count == 0) {
                    ...
                    int startDelay = mRefreshHeader.onFinish(FJRefresh.this, success);
                    if (mOnMultiPurposeListener != null && mRefreshHeader instanceof RefreshHeader) {
                    ...
                    if (startDelay < Integer.MAX_VALUE) {
                        ...
                        if (mIsBeingDragged || mNestedInProgress) {
                            ...
                            if (mIsBeingDragged) {
                                ...
                                mTouchSpinner = 0;
                                mIsBeingDragged = false;
                                FJRefresh.super.dispatchTouchEvent(obtain(time, time, MotionEvent.ACTION_DOWN, mLastTouchX, mLastTouchY + mSpinner - mTouchSlop * 2, 0));
                                FJRefresh.super.dispatchTouchEvent(obtain(time, time, MotionEvent.ACTION_MOVE, mLastTouchX, mLastTouchY + mSpinner, 0));
                            }
                            if (mNestedInProgress) {
                                mTotalUnconsumed = 0;
                                FJRefresh.super.dispatchTouchEvent(obtain(time, time, MotionEvent.ACTION_UP, mLastTouchX, mLastTouchY, 0));
                                mNestedInProgress = false;
                                mTouchSpinner = 0;
                            }
                        }
        ...
        Runnable runnable = new Runnable() {
            ...
            public void run() {
                if (count == 0) {
                    ...
                    final int startDelay = mRefreshFooter.onFinish(FJRefresh.this, success);
                    if (mOnMultiPurposeListener != null && mRefreshFooter instanceof RefreshFooter) {
                    ...
                    if (startDelay < Integer.MAX_VALUE) {
                        ...
                        if (mIsBeingDragged || mNestedInProgress) {
                            ...
                            if (mIsBeingDragged) {
                                ...
                                FJRefresh.super.dispatchTouchEvent(obtain(time, time, MotionEvent.ACTION_DOWN, mLastTouchX, mLastTouchY + offsetY + mTouchSlop * 2, 0));
                                FJRefresh.super.dispatchTouchEvent(obtain(time, time, MotionEvent.ACTION_MOVE, mLastTouchX, mLastTouchY + offsetY, 0));
                            }
                            if (mNestedInProgress) {
                                mTotalUnconsumed = 0;
                                FJRefresh.super.dispatchTouchEvent(obtain(time, time, MotionEvent.ACTION_UP, mLastTouchX, mLastTouchY, 0));
        ...
        if (mState == RefreshState.None && isEnableRefreshOrLoadMore(mEnableRefresh)) {
            Runnable runnable = new Runnable() {
                ...
                public void run() {
                    ...
                    final View thisView = FJRefresh.this;
                    mLastTouchX = thisView.getMeasuredWidth() / 2f;
                    mKernel.setState(RefreshState.PullDownToRefresh);
    ...
    public class RefreshKernelImpl implements RefreshKernel {
        ...
        public ValueAnimator animSpinner(int endSpinner) {
            return FJRefresh.this.animSpinner(endSpinner, 0, mReboundInterpolator, mReboundDuration);
        }
        //</editor-fold>
    ...
    public FJRefresh setOnTouchListener(OnTouchEventListener listener) {
    ...
    public interface OnTouchEventListener {
        ...
        void onMove(float scrollY);

        void onUp(float scrollY);
    }
}
