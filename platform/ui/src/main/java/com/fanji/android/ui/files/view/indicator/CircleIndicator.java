package com.fanji.android.ui.files.view.indicator;
...
public class CircleIndicator extends LinearLayout {
  ...
  private final ViewPager.OnPageChangeListener
      mInternalPageChangeListener = new ViewPager.OnPageChangeListener() {
