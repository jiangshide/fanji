 ...
 */
public class FJPagerAdapter extends PagerAdapter implements View.OnClickListener {
    private Context mContext;
    private List<View> mViews;
    private boolean mIsLimitWidth = false;
    private OnPagerItemClickListener mOnPagerItemClickListener;

    public FJPagerAdapter(Context context) {
        this.mContext = context;
    }

    public FJPagerAdapter setViews(List<View> views) {
        return this.setViews(views, mIsLimitWidth);
    }

    public FJPagerAdapter setViews(List<View> views, Boolean isLimitWidth) {
        this.mViews = views;
