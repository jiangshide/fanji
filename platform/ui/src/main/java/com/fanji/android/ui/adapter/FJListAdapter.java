 ...
 */
public abstract class FJListAdapter<T> extends BaseAdapter implements View.OnClickListener {
  ...
  public FJListAdapter(Context context, List<T> data) {
    this.mContext = context;
    this.mData = data;
    this.mLayoutId = R.layout.default_list_item;
  }

  public FJListAdapter(Context context, int layoutId) {
    this.mContext = context;
    this.mData = new ArrayList<>();
    this.mLayoutId = layoutId;
  }

  public FJListAdapter(Context context, List<T> data, int layoutId) {
    this.mContext = context;
    this.mData = data;
    this.mLayoutId = layoutId;
  }

  public FJListAdapter(Context context, List<T> data, int layoutId, Callback callback) {
    this.mContext = context;
    this.mData = data;
    this.mLayoutId = layoutId;
  ...
  public FJListAdapter<T> setViewTypeCount(int count) {
    this.count = count;
    return this;
  }

  public FJListAdapter<T> setItemViewType(int index) {
    this.index = index;
    return this;
  }
