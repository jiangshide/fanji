 ...
 */
public class FJEditText extends AppCompatEditText
    ...
    public FJEditText(Context context) {
        this(context, null);
    }

    public FJEditText(Context context, AttributeSet attrs) {
        this(context, attrs, android.R.attr.editTextStyle);
    }

    public FJEditText(Context context, AttributeSet attrs, int defStyle) {
    ...
    public FJEditText setRequestSize(int length) {
        this.mLength = length;
        return this;
    }

    public FJEditText setListener(CusEditListener listener) {
        this.mCusEditListener = listener;
        return this;
    }

    public FJEditText setKetListener(KeyboardListener listener) {
        this.mKeyboardListener = listener;
        return this;
    }

    public FJEditText setPswHide(boolean isPswHide) {
        setTransformationMethod(isPswHide ? HideReturnsTransformationMethod.getInstance() : PasswordTransformationMethod.getInstance());
        return this;
    }

    public FJEditText setMaxLength(int size) {
    ...
    public FJEditText setKeyBoardListener(Activity activity, OnKeyboardListener listener) {
    ...
    public FJEditText setFocusListener(OnFocusListener listener) {
     ...
     */
    public FJEditText setNormalColor(int normalColor) {
     ...
     */
    public FJEditText setNormalColor(String normalColor) {
     ...
     */
    public FJEditText setCurrCorner(float currCorner) {
     ...
     */
    public FJEditText setStrokeWidth(float strokeWidth) {
     ...
     */
    public FJEditText setStrokeColor(int strokeColor) {
     ...
     */
    public FJEditText setStrokeColor(String strokeColor) {
