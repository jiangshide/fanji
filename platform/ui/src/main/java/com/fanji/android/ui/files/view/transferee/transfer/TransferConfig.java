package com.fanji.android.ui.files.view.transferee.transfer;
...
import com.fanji.android.ui.files.view.transferee.loader.ImageLoader;
import com.fanji.android.ui.files.view.transferee.style.IIndexIndicator;
import com.fanji.android.ui.files.view.transferee.style.IProgressIndicator;
...
public class TransferConfig {
  ...
  public Drawable getMissDrawable(Context context) {
    if (missDrawable != null)
      ...
      return context.getResources().getDrawable(R.mipmap.image_placeholder);
  }
  ...
  public static class Builder {
     ...
     */
    public Builder setSourceImage(String url) {
      ArrayList arrayList = new ArrayList();
      arrayList.add(url);
      return setSourceImageList(arrayList);
    }
