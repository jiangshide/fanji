...
import com.fanji.android.ui.files.view.transferee.style.index.CircleIndexIndicator;
import com.fanji.android.ui.files.view.transferee.style.progress.ProgressBarIndicator;
...
public class Transferee implements DialogInterface.OnShowListener,
    ...
    private void fillPlaceHolder(List<ImageView> originImageList, int totalCount, int firstPos,
                                 int lastPos) {
        if (firstPos > 0) {
