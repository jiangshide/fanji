 ...
 */
public class FJTopView extends LinearLayout implements View.OnClickListener {
    ...
    public FJTopView(Context context) {
        this(context, null);
    }

    public FJTopView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public FJTopView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public FJTopView showView(boolean isShow) {
        topL.setVisibility(isShow ? View.VISIBLE : View.GONE);
        return this;
    }

    public FJTopView setBg(int resIcon) {
        mBgIcon = resIcon;
        //invalidate();
    ...
    public FJTopView setLeftTint(int color) {
        return this;
    }

    public FJTopView setTitleGravity(int gravity) {
        topTitleL.setGravity(gravity);
        return this;
    }

    public FJTopView setTitle(Object object) {
    ...
    public FJTopView setTitleColor(int color) {
        topTitle.setTextColor(getResources().getColor(color));
        return this;
    }

    public FJTopView setSmallTitle(Object object) {
        if (object == null) return showView(false);
        String title = "";
        if (object instanceof String) {
            title = (String) object;
    ...
    public FJTopView setSmallTitleColor(int color) {
        topTitleSmall.setTextColor(getResources().getColor(color));
        return this;
    }

    public FJTopView setLefts(Object object) {
        if (object == null) return showView(false);
        if (object instanceof String) {
    ...
    public FJTopView setLeftColor(int color) {
        topLeftBtn.setTextColor(color);
        return this;
    }

    public FJTopView setRights(Object object) {
        if (object == null) return showView(false);
        if (object instanceof String) {
    ...
    public FJTopView setRightColor(int color) {
        topRightBtn.setTextColor(getResources().getColor(color));
        return this;
    }

    public FJTopView setDataList(List<String> dataList) {
        this.mDataList = dataList;
        return this;
    }

    public FJTopView setOnLeftClick(OnClickListener listener) {
        this.mOnLeftClickListener = listener;
        topLeftBtn.setVisibility(listener != null ? VISIBLE : INVISIBLE);
        return this;
    }

    public FJTopView setOnRightClick(OnClickListener listener) {
        this.mOnRightClickListener = listener;
        topRightBtn.setVisibility(listener != null ? VISIBLE : INVISIBLE);
        return this;
    }

    public FJTopView setOnItemListener(AdapterView.OnItemClickListener listener) {
    ...
    public void onClick(View v) {
        ...
        if (id == R.id.topLeftBtn) {
            ...
            if (mDataList != null && mDataList.size() > 0) {
                FJDialog zdDialog = FJDialog.createList(getContext(), mDataList);
