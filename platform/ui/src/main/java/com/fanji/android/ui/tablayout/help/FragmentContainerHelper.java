...
public class FragmentContainerHelper {
    private List<FJTabLayout> mZdTabLayoutList = new ArrayList<FJTabLayout>();
    ...
    public FragmentContainerHelper(FJTabLayout zdTabLayout) {
    ...
    public void attachMagicIndicator(FJTabLayout zdTabLayout) {
        mZdTabLayoutList.add(zdTabLayout);
    }

    private void dispatchPageSelected(int pageIndex) {
        for (FJTabLayout zdTabLayout : mZdTabLayoutList) {
