...
/**
 * created by jiangshide on 2019-09-23.
 * email:18311271399@163.com
 */
public class FJSwitch extends View implements Checkable {
    /**
     * static state
     */
    ...
    public FJSwitch(Context context) {
        super(context);
        init(context, null);
    }

    public FJSwitch(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public FJSwitch(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context, attrs);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public FJSwitch(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        shadowRadius = optPixelSize(typedArray,
                R.styleable.SwitchButton_shadowRadius,
                dp2pxInt(2.5f));//dp2pxInt(2.5f);

        shadowOffset = optPixelSize(typedArray,
                R.styleable.SwitchButton_shadowOffset,
                dp2pxInt(1.5f));//dp2pxInt(1.5f);

        shadowColor = optColor(typedArray,
                R.styleable.SwitchButton_shadowColor,
                0X33000000);//0X33000000;

        uncheckColor = optColor(typedArray,
                R.styleable.SwitchButton_uncheckColor,
    ...
    public interface OnCheckedChangeListener {
        void onCheckedChanged(FJSwitch view, boolean isChecked);
    }
