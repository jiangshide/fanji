package com.fanji.android.ui.recycleview.divider;
...
/**
 * created by jiangshide on 2019-10-03.
...
public class CommonItemDecoration extends RecyclerView.ItemDecoration {
  ...
  public CommonItemDecoration(int horizontalSpace, int verticalSpace, int leftMargin, int topMargin,
    ...
    mPaint.setColor(Color.parseColor("#F4F6FE"));        //默认颜色
  }

  //设置颜色
  public CommonItemDecoration setColor(int color) {
  ...
  @Override public void onDraw(@NonNull Canvas c, @NonNull RecyclerView parent,
    ...
    for (int i = 0; i < childCount; i++) {
      ...
      float dividerTop = view.getTop() - verticalSpace;
      float dividerLeft = parent.getPaddingLeft() + leftMargin;
