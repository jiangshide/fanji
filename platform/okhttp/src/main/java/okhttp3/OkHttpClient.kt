...
open class OkHttpClient internal constructor(
  ...
  @get:JvmName("saveEventDb")val saveEventDb:Boolean=builder.saveEventDb
  ...
  @get:JvmName("netState") val netState: Boolean = builder.netState
  @get:JvmName("netLevel") val netLevel: Int = builder.netLevel
  @get:JvmName("netSpeed") val netSpeed: Float = builder.netSpeed
  ...
  class Builder constructor() {
    ...
    internal var saveEventDb:Boolean = true
    ...
    internal var netState = false
    internal var netLevel = 0
    internal var netSpeed = 0f
    ...
    internal constructor(okHttpClient: OkHttpClient) : this() {
      ...
      this.saveEventDb = okHttpClient.saveEventDb
      ...
      this.netState = okHttpClient.netState
      this.netLevel = okHttpClient.netLevel
      this.netSpeed = okHttpClient.netSpeed
    ...
    fun saveEventDb(saveEventDb:Boolean)= apply {
        this.saveEventDb = saveEventDb
    }
