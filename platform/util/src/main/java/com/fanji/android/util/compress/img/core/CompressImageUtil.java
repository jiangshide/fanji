package com.fanji.android.util.compress.img.core;
...
import com.fanji.android.util.compress.img.config.CompressConfig;
import com.fanji.android.util.compress.img.listener.CompressResultListener;
import com.fanji.android.util.compress.img.utils.Constants;
...
public class CompressImageUtil {
    ...
    private File getPhotoCacheDir(File file) {
        ...
        Log.e("learn >>> ", mCacheDir.getAbsolutePath());
