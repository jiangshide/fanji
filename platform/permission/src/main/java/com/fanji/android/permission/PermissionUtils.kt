...
internal object PermissionUtils {
    ...
    fun isGrantedStoragePermission(context: Context): Boolean {
        ...
        } else FJPermission.isGranted(context, Permission.Group.STORAGE)
    }
    ...
    fun isSpecialPermission(permission: String?): Boolean {
        return Permission.MANAGE_EXTERNAL_STORAGE == permission ||
                Permission.REQUEST_INSTALL_PACKAGES == permission ||
                Permission.SYSTEM_ALERT_WINDOW == permission ||
                Permission.NOTIFICATION_SERVICE == permission ||
