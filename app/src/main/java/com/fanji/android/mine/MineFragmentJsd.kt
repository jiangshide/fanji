...
import com.fanji.android.databinding.FragmentMineJsdBinding
 ...
 * @Description:
 */
class MineFragmentJsd : BaseFragment<FragmentMineJsdBinding>() {

    override fun viewBinding(
        inflater: LayoutInflater,
        container: ViewGroup?
    ) = FragmentMineJsdBinding.inflate(layoutInflater)
