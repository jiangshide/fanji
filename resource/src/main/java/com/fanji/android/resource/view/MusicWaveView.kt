...
import com.fanji.android.util.EncryptUtils
...
class MusicWaveView(context: Context, attrs: AttributeSet?) : View(context, attrs) {
    ...
    init {
        ...
        columnMinHeight =
            context.resources.getDimensionPixelSize(R.dimen.music_wave_column_min_height)
        ...
        colorUp = ContextCompat.getColor(context, com.fanji.android.ui.R.color.blueLight)
        colorUpMask = ContextCompat.getColor(context, com.fanji.android.ui.R.color.blueLight)
        colorDown = ContextCompat.getColor(context, com.fanji.android.ui.R.color.blue)
        colorDownMask = ContextCompat.getColor(context, com.fanji.android.ui.R.color.bg)
        paint = Paint()
//        updateMusic(music)
    }
