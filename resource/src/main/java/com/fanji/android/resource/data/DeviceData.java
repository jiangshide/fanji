package com.fanji.android.resource.data;
...
public class DeviceData {
  ...
  public DeviceData(Activity activity) {
    ...
    netName = NetState.Companion.getInstance().getNetWorkTypeName(activity);
    netSpeed = NetState.Companion.getInstance().getNetSpeed(activity);
    inumeric = "";
