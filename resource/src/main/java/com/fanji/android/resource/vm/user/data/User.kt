...
//                text.setDrawableLeft(R.mipmap.secrecy)
    ...
    override fun toString(): String {
        return "User(name=$name, status=$status, reason=$reason, fansNum=$fansNum, followsNum=$followsNum, channelsNum=$channelsNum, blogsNum=$blogsNum, activeNum=$activeNum, remark='$remark', friends=$friends, follows=$follows, reportr=$reportr, ignoreBind=$ignoreBind, selected=$selected)"
    }
