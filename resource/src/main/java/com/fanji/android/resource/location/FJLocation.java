package com.fanji.android.resource.location;
...
import com.fanji.android.resource.location.listener.IAmapListener;
import com.fanji.android.resource.location.listener.ILocationListener;
...
public class FJLocation {
    ...
    public void startLocation(boolean isOnce, AMapLocationListener locationListener) {
        this.mLocationListener = locationListener;
